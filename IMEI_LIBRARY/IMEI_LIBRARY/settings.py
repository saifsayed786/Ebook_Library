"""
Django settings for IMEI_LIBRARY project.
...
SECRET_KEY = 'enan$c3))1$i0^u9_258ku6)s-4q%h*&pg%ayc)e)wem4$pobi'
...
ROOT_URLCONF = 'IMEI_LIBRARY.urls'
...
WSGI_APPLICATION = 'IMEI_LIBRARY.wsgi.application'
